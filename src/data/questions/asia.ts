...
// ============================================================================
// ASIA - BATCH 4: REACHING 500 MILESTONE (16 questions)
// ============================================================================

const milestoneBatch4: Question[] = [
    {
        id: 'asia-sports-004',
        continent: 'ASIA',
        category: 'SPORTS',
        ...
        difficulty: 0.4,
        fascinationScore: 0.9,
        hookText: 'Which Asian country hosted the first FIFA World Cup ever held in Asia?',
        options: [
            { id: 'a', text: 'China' },
            { id: 'b', text: 'Japan' },
            { id: 'c', text: 'South Korea' },
            { id: 'd', text: 'Japan & South Korea (co-hosted)' },
        ],
        correctAnswer: 'd',
        explanation: 'Japan and South Korea co-hosted the 2002 World Cup — the first ever held in Asia! Brazil won, and there were many surprises including South Korea reaching the semi-finals. It was also the first World Cup hosted by two countries! ⚽',
        explanationShort: '2002 World Cup: Japan + South Korea — first Asian hosts!',
        source: 'FIFA',
    },
    {
        id: 'asia-sci-004',
        ...
        difficulty: 0.5,
        fascinationScore: 0.92,
        hookText: 'India\'s Mars Orbiter Mission succeeded on the first try. How much did it cost?',
        options: [
            { id: 'a', text: 'About $74 million' },
            { id: 'b', text: 'About $200 million' },
            { id: 'c', text: 'About $500 million' },
            { id: 'd', text: 'About $1 billion' },
        ],
        correctAnswer: 'a',
        explanation: 'India\'s Mangalyaan cost only $74 million — less than the movie "Gravity"! It was the first mission to reach Mars on the first attempt, and the cheapest Mars mission ever. India is now fourth in the world to reach Mars. 🚀',
        explanationShort: 'Mangalyaan: $74 million — cheaper than the movie Gravity!',
        source: 'ISRO',
    },
    {
        id: 'asia-food-007',
        ...
        difficulty: 0.4,
        fascinationScore: 0.9,
        hookText: 'Instant noodles were invented in which Asian country?',
        options: [
            { id: 'a', text: 'China' },
            { id: 'b', text: 'Japan' },
            { id: 'c', text: 'South Korea' },
        ...
        correctAnswer: 'b',
        explanation: 'Momofuku Ando invented instant ramen in Japan in 1958! He also invented Cup Noodles in 1971. Today, 100 billion servings of instant noodles are sold yearly worldwide. Ando was voted the greatest Japanese invention of the 20th century! 🍜',
        explanationShort: 'Instant noodles: Japan 1958 — 100 billion eaten yearly!',
        source: 'Nissin Foods',
    },
    {
        id: 'asia-fam-007',
        ...
        difficulty: 0.3,
        fascinationScore: 0.88,
        hookText: 'Sachin Tendulkar of India is called the "God of Cricket." What record does he hold?',
        options: [
            { id: 'a', text: 'Most centuries in international cricket' },
            { id: 'b', text: 'Most wickets' },
            { id: 'c', text: 'Fastest bowler' },
            { id: 'd', text: 'Most catches' },
        ],
        correctAnswer: 'a',
        explanation: 'Sachin Tendulkar holds the record for most centuries (100) and most runs ever in international cricket! He played for 24 years and is worshipped in India. When he retired in 2013, the entire nation mourned. He was the first batsman to score 200 in ODI! 🏏',
        explanationShort: 'Sachin: 100 centuries — "God of Cricket" for 24 years!',
        source: 'ICC',
    },
    {
        id: 'asia-geo-008',
        ...
        difficulty: 0.4,
        fascinationScore: 0.92,
        hookText: 'Tokyo is the world\'s most populous metropolitan area. How many people live there?',
        options: [
            { id: 'a', text: 'About 25 million' },
            { id: 'b', text: 'About 30 million' },
            { id: 'c', text: 'About 37 million' },
            { id: 'd', text: 'About 45 million' },
        ],
        correctAnswer: 'c',
        explanation: 'Tokyo has about 37 million people — more than all of Canada! The trains are so crowded that "pushers" help squeeze people onto them. Despite the density, Tokyo is one of the safest and cleanest cities in the world. 🗼',
        explanationShort: 'Tokyo: 37 million — more than all of Canada!',
        source: 'Tokyo Metropolitan Government',
    },
    {
        id: 'asia-fun-013',
        ...
        difficulty: 0.4,
        fascinationScore: 0.9,
        hookText: 'South Korea has the fastest internet in the world. How fast is it on average?',
        options: [
            { id: 'a', text: 'About 50 Mbps' },
            { id: 'b', text: 'About 100 Mbps' },
            { id: 'c', text: 'About 200 Mbps' },
            { id: 'd', text: 'About 300 Mbps' },
        ],
        correctAnswer: 'c',
        explanation: 'South Korea averages about 200+ Mbps — the fastest in the world! 95% of homes have internet. E-sports (gaming) is a national phenomenon with pro gamers as celebrities. Kids go to "PC bangs" (gaming cafes) after school! 💻',
        explanationShort: 'South Korea: 200 Mbps average — e-sports celebrities!',
    ...
    },
    {
        ...
        difficulty: 0.4,
        fascinationScore: 0.88,
        hookText: 'Origami, the art of paper folding, originated in which country?',
        options: [
            { id: 'a', text: 'China' },
            { id: 'b', text: 'Japan' },
            { id: 'c', text: 'Korea' },
        ...
        correctAnswer: 'b',
        explanation: 'Origami ("folding paper") developed in Japan starting in the 6th century! Paper came from China, but the Japanese perfected the art. Scientists now use origami to design satellite solar panels and medical stents. One piece of paper, no cuts, infinite possibilities! 📄',
        explanationShort: 'Origami: Japan 6th century — now used for satellite design!',
        source: 'Japan Origami Association',
    },
    {
        id: 'asia-rec-006',
        continent: 'ASIA',
        ...
        difficulty: 0.4,
        fascinationScore: 0.9,
        hookText: 'Japan\'s Shinkansen bullet trains are famous for being on time. What\'s their average delay per year?',
        options: [
            { id: 'a', text: 'About 5 minutes' },
            { id: 'b', text: 'About 30 seconds' },
            { id: 'c', text: 'About 2 minutes' },
            { id: 'd', text: 'About 10 seconds' },
        ],
        correctAnswer: 'b',
        explanation: 'The Shinkansen averages less than 1 minute delay PER YEAR! In 60 years, there have been zero fatal accidents. They travel at 320 km/h and carry 400 million passengers yearly. When delays occur, passengers get formal apology certificates! 🚄',
        explanationShort: 'Shinkansen: 30 seconds average delay — per YEAR!',
        source: 'JR Central',
    },
    {
        id: 'asia-nature-006',
        ...
        difficulty: 0.4,
        fascinationScore: 0.92,
        hookText: 'Giant pandas are native to China. How many are left in the wild?',
        options: [
            { id: 'a', text: 'About 500' },
            { id: 'b', text: 'About 1,000' },
            { id: 'c', text: 'About 1,800' },
        ...
        correctAnswer: 'c',
        explanation: 'About 1,800 giant pandas live in the wild — up from just 1,100 in the 1980s! China rents pandas to zoos for $1 million per year per panda. Any panda born abroad belongs to China. Conservation efforts have upgraded them from "endangered" to "vulnerable"! 🐼',
        explanationShort: 'Pandas: 1,800 in wild — $1 million/year rental fee!',
        source: 'WWF',
    },
    {
        id: 'asia-hist-007',
        ...
        difficulty: 0.5,
        fascinationScore: 0.88,
        hookText: 'The ancient Silk Road connected China to which region?',
        options: [
            { id: 'a', text: 'Africa' },
            { id: 'b', text: 'Europe and Middle East' },
            { id: 'c', text: 'India only' },
            { id: 'd', text: 'Japan' },
        ],
        correctAnswer: 'b',
        explanation: 'The Silk Road connected China to the Mediterranean Sea through Central Asia and the Middle East! It was 6,400 km long and operated for 1,500 years (130 BCE - 1453 CE). Silk, spices, paper, and ideas traveled both ways. Marco Polo used it! 🐫',
        explanationShort: 'Silk Road: 6,400 km — China to Europe for 1,500 years!',
        source: 'UNESCO',
    },
    {
        id: 'asia-fun-014',
        ...
        difficulty: 0.3,
        fascinationScore: 0.93,
        hookText: 'K-pop group BTS is from which country?',
        options: [
            { id: 'a', text: 'Japan' },
            { id: 'b', text: 'China' },
            { id: 'c', text: 'South Korea' },
        ...
        correctAnswer: 'c',
        explanation: 'BTS is from South Korea and is one of the biggest bands in history! They\'ve sold 40+ million albums and have billions of streams. K-pop generates $10 billion annually for Korea. Korean culture (Hallyu) has taken over the world — films, music, skin care, everything! 🎤',
        explanationShort: 'BTS: South Korea — $10 billion K-pop industry!',
    ...
    },
    {
        ...
        difficulty: 0.4,
        fascinationScore: 0.88,
        hookText: 'India produces how much of the world\'s spices?',
        options: [
            { id: 'a', text: 'About 30%' },
            { id: 'b', text: 'About 50%' },
            { id: 'c', text: 'About 70%' },
        ...
        correctAnswer: 'c',
        explanation: 'India produces about 70% of the world\'s spices! Kerala is called the "Spice Coast." The spice trade shaped world history — Columbus discovered America while looking for a spice route to India. India grows over 100 varieties of spices! 🌶️',
        explanationShort: 'India: 70% of world\'s spices — Columbus sought spice route!',
    ...
    },
    {
        ...
        difficulty: 0.5,
        fascinationScore: 0.9,
        hookText: 'Taiwan produces what percentage of the world\'s advanced microchips?',
        options: [
            { id: 'a', text: 'About 50%' },
            { id: 'b', text: 'About 70%' },
            { id: 'c', text: 'About 90%' },
        ...
        correctAnswer: 'c',
        explanation: 'Taiwan\'s TSMC produces about 90% of the world\'s most advanced chips (under 7nm)! Without Taiwan, no one could make iPhones, Nvidia GPUs, or modern cars. This tiny island is the most important place in the global tech supply chain. 💾',
        explanationShort: 'Taiwan TSMC: 90% of advanced chips — no phones without them!',
        source: 'TSMC',
    },
    {
        id: 'asia-geo-009',
        ...
        difficulty: 0.4,
        fascinationScore: 0.87,
        hookText: 'Indonesia is the world\'s largest archipelago nation. How many islands does it have?',
        options: [
            { id: 'a', text: 'About 7,500' },
            { id: 'b', text: 'About 13,000' },
            { id: 'c', text: 'About 17,500' },
            { id: 'd', text: 'About 22,000' },
        ],
        correctAnswer: 'c',
        explanation: 'Indonesia has about 17,500 islands! Only 6,000 are inhabited. It stretches wider than the USA (coast to coast). It has 270 million people (4th largest), 700+ languages, and the world\'s largest Muslim population. A nation of incredible diversity! 🏝️',
        explanationShort: 'Indonesia: 17,500 islands — wider than USA, 700+ languages!',
        source: 'Indonesian Government',
    },
    {
        id: 'asia-cult-005',
        ...
        difficulty: 0.4,
        fascinationScore: 0.88,
        hookText: 'Buddhism originated in which country?',
        options: [
            { id: 'a', text: 'China' },
            { id: 'b', text: 'Japan' },
            { id: 'c', text: 'India' },
        ...
        correctAnswer: 'c',
        explanation: 'Buddhism was founded by Siddhartha Gautama (Buddha) in India around 500 BCE! He gained enlightenment under a Bodhi tree in Bodh Gaya. Buddhism spread across Asia and now has 500 million followers. But it nearly disappeared in India itself! 🙏',
        explanationShort: 'Buddhism: India 500 BCE — now 500 million followers worldwide!',
    ...
    },
    {
        ...
        difficulty: 0.4,
        fascinationScore: 0.9,
        hookText: 'Singapore is one of only three city-states in the world. What is it famous for?',
        options: [
            { id: 'a', text: 'Being the cleanest city' },
            { id: 'b', text: 'Banning chewing gum' },
            { id: 'c', text: 'Having the world\'s best airport' },
            { id: 'd', text: 'All of the above' },
        ],
        correctAnswer: 'd',
        explanation: 'Singapore is famous for all three! Chewing gum is banned (since 1992). Changi Airport is voted best in the world yearly. Littering fines are $1,000. Despite being tiny (5.5 million people), it\'s one of the richest and most successful nations! 🇸🇬',
        explanationShort: 'Singapore: Gum banned, cleanest city, best airport — all true!',
